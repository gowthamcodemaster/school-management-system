...
var PrismaService = function () {
    ...
    var PrismaService = _classThis = /** @class */ (function (_super) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            modelNames = Object.keys(this).filter(function (key) {
                            ...
                            return [4 /*yield*/, Promise.all(modelNames.map(function (modelName) {
                                    var model = _this[modelName];
         ...
         */
        PrismaService_1.prototype.enableQueryLogging = function () {
            var _this = this;
            this.$on('query', function (e) {
                // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
                _this.logger.debug("Query: ".concat(e.query));
                // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
                _this.logger.debug("Duration: ".concat(e.duration, "ms"));
            });
        };
